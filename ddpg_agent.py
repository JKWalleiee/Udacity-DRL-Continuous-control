...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, bn_bool=False, fa1_units=400, fa2_units=300, fc1_units=400, fc2_units=300,
                BUFFER_SIZE_=BUFFER_SIZE, BATCH_SIZE_=BATCH_SIZE, GAMMA_=GAMMA, TAU_=TAU, LR_ACTOR_=LR_ACTOR, LR_CRITIC_=LR_CRITIC, WEIGHT_DECAY_= WEIGHT_DECAY,
                mu_=0., theta_=0.15, sigma_=0.2):
        ...
        self.actor_local = Actor(state_size, action_size, random_seed, bn_bool, fa1_units, fa2_units).to(device)
        self.actor_target = Actor(state_size, action_size, random_seed, bn_bool, fa1_units, fa2_units).to(device)
        ...
        self.critic_local = Critic(state_size, action_size, random_seed, bn_bool,fc1_units, fc2_units).to(device)
        self.critic_target = Critic(state_size, action_size, random_seed, bn_bool,fc1_units, fc2_units).to(device)
