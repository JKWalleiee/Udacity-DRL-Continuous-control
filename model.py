...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, bn_bool, fa1_units=400, fa2_units=300):
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, bn_bool, fc1_units=400, fc2_units=300):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
